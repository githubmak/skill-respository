...
只使用服务当前节拍的职责。镜头可以提供新信息，也可以通过延迟、重复、遮蔽或静止重新改变既有信息的意义；不得无因重复。
...
一个中短时长的16:9连续生成段可按剧情需要使用若干覆盖单元，例如：
...
- 每镜先明确观众此刻主要需要看清或感受什么，再决定采用单一摄影意图或由同一动作因果驱动的复合摄影意图。复合路径可以在一镜内变速、变高、转弧或交接焦点，但每次变化都要有可见触发、连续空间关系和清楚的观看中心。
...
- 高潮后的镜头可以更稳、更宽、更慢，也可以因剧情继续失控而更近、更碎或突然断黑；选择取决于新的权力关系和代价如何最有力地落地。
...
- 决定性变化后没有任何足以读清新空间归属的证据；证据可以是停顿，也可以是连续运动中的构图、声音、焦点或环境结果。
