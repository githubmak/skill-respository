...
提示词质量先过第一层“不穿帮硬门槛”：人物位置、身体面向、道具归属、口型、尾帧继承、单镜不过载、状态变化中间态必须稳定。任一项不稳，优先拆镜、补定位镜头、减少入画人物、降低运镜或退回连续性/空间合同。通过硬门槛后才进入第二层“创作表现权重”：剧情节拍与观众认知 > 情绪表演张力 > 景别层次与镜头变化 > 声音氛围和装饰细节。不得为了镜头变化、氛围或装饰牺牲剧情认知、空间连续、道具归属和口型。
