...
RULES = {
    "prop_functional_surface_orientation": {
        ...
        "checks": {
            "SKILL.md": ("prop_functional_surface_contract", "背壳/背面/侧边朝摄影机", "普通静置或递交不触发"),
            ...
            "references/agents/03_master_production_agent.md": ("prop_functional_surface_contract", "不能为了展示内容让人物观看道具背面"),
            ...
            "scripts/modec_v4.py": ("def prop_functional_surface_contract_issues", "FUNCTIONAL_SURFACE_VISIBILITY_MODES"),
    ...
    "skin_tone_protection": {
        "label": "人物肤色保护与环境光影边界",
        "checks": {
            "SKILL.md": ("skin_tone_protection_contract", "丁达尔光束", "source_authorized_marks/silhouette"),
            ...
            "references/agents/03_master_production_agent.md": ("skin_tone_protection_contract", "不让环境色卡统管皮肤"),
            ...
            "scripts/modec_v4.py": ("def skin_tone_protection_contract_issues", "ACCIDENTAL_FACE_CONTAMINATION_PATTERNS"),
    ...
    "natural_conversation_rhythm": {
        "label": "真实会话节奏与源文约束",
        "checks": {
            "SKILL.md": ("conversation_mode/response_latency", "短暂声音重叠", "不改字、不增词"),
            ...
            "references/agents/03_master_production_agent.md": ("conversation_source_basis", "短暂声音重叠优先使用画外声"),
            ...
            "scripts/modec_v4.py": ("CONVERSATION_MODES", "非顺序轮次必须写overlap_or_interrupt_window"),
    ...
    "character_action_relationship_arc": {
        "label": "角色戏剧行动与关系情绪弧",
        "checks": {
            "SKILL.md": ("character_scene_objective_contract", "relationship_emotion_arc", "信息差"),
            ...
            "scripts/modec_v4.py": ("def character_scene_objective_issues", "def relationship_emotion_arc_issues"),
    ...
    "landscape_environment_story": {
        "label": "风景美学与环境叙事",
        "checks": {
            "SKILL.md": ("风景导演事实", "差速自然运动", "环境起态→剧情触发→余波"),
            ...
            "scripts/modec_v4.py": ("风景身份/构图/自然运动", "light_weather_progression"),
    ...
    "sequence_cut_directing": {
        "label": "序列导演语言与剪辑切点",
        "checks": {
            "SKILL.md": ("sequence_directing_plan", "cut_decision_contract", "切后信息增量"),
            ...
            "scripts/modec_v4.py": ("def sequence_directing_plan_issues", "def cut_decision_contract_issues"),
    ...
    "adaptive_prompt_information_budget": {
        "label": "自适应提示词信息预算",
        "checks": {
            "SKILL.md": ("prompt_information_budget", "1–2个视觉增强点"),
            ...
            "scripts/modec_v4.py": ("def prompt_information_budget_issues", "PROMPT_INFORMATION_PROFILES"),
    ...
    "spatial_sound_directing": {
        "label": "空间声音与声画导演",
        "checks": {
            "SKILL.md": ("sound_directing_plan", "方向与距离", "声音先于画面进入"),
            ...
            "scripts/modec_v4.py": ("def sound_directing_plan_issues", "SOUND_DIRECTING_PLAN_FIELDS"),
    ...
    "lived_in_scene_depth": {
        ...
        "checks": {
            ...
            "references/agents/03_master_production_agent.md": ("foreground_layer/midground_layer/background_layer", "景色舒服"),
            ...
            "scripts/modec_v4.py": ("至少两层具体场景细节", "题材视觉气味或生活化使用痕迹"),
    ...
    "high_quality_fast_mode": {
        "label": "高质量快速模式",
        "checks": {
            "SKILL.md": ("高质量快速模式", "--auto-start", "不得跳过任何管线阶段"),
    ...
    "production_intelligence": {
        ...
        "checks": {
            "SKILL.md": ("隐性视觉先验", "prop_lifecycle_contract", "perspective_scale_contract", "lighting_topology_contract", "关键帧/T2V事实一致性"),
            ...
            "references/agents/03_master_production_agent.md": ("动作失败风险", "透视是物理关系"),
