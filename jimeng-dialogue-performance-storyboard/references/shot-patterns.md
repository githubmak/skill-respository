...
以下语句展示怎样把高风险物理关系写清。人物、画面左右、距离、机位和固定物必须按当前导演方案重建，不能原样套用。
...
`若镜头A从A肩后拍B，常规反打可从B肩后拍A，并继承双方身体朝向、距离、隔物、道具和背景锚点。导演若有意改变机位或越轴，应拍出能让观众理解的新空间关系，而不是用模糊机位跳过变化。`
...
- 新地点、新群体关系或调度变化：考虑用全景或中景建立关系，并给观众足够时间读清锚点。
- 对白交锋：前景肩线或双人中近景可强化立场；同一时间只让实际说话者开口。
...
- 压力：可从斜向关系镜头、推近、落焦、留白或静止中选择最能显出权力变化的方式；人物物理位置保持可解释。
...
当台词真正刺中对方、关系权力变化、道具意义变化或沉默余波比台词更重要时，可从以下功能镜头中自由选择、合并或改写。不要机械套用固定镜数，但要让关键反应被看见。
...
先按戏剧功能理解人物策略，再根据当前道具和身体状态创造动作。泄露点数量由景别、台词和动作负荷决定，重点是避免无因堆叠和重复套用。
...
- 建立两者真实脚底与地面关系，再决定摄影机在儿童眼高、成人胸高或两者之间。低机位可进入儿童立场，成人胸高可显出保护或压力；不能靠缩放人物解决同框。
- 递物、牵手和遮挡要符合触达。成人弯腰、蹲下或孩子举高手臂是剧情动作，起态和终态都需可见。

### 多人边界关系

- 先锁边界两侧与过渡区域，以固定门框、走廊边缘或桌边定义场景左右。每位关键人物的槽位、朝向和视线分别写，不用“大家围着他”替代。
- 发言者、关键证据和接收者形成主关系，其余人物保留不同职责，例如承载道具、守住边界或观察。摄影机若横移，单独写摄影机沿固定边界的路径；人物与道具不共享该路径。

### 听者主导的对白

- 台词不一定把镜头锁在说话者脸上。可从说话者肩后看关键听者、在证据与听者之间转焦，或先保留说话者口型再切听者余波。
- 让口型归属可读：画内说话者可见时正常开口；画外说话者用 OS，画内听者闭口。摄影机选择服务关系变化，不机械正反打。

### 共同劳动中的对白

- 将任务拆成不冲突的职责：一人择菜、一人扶篮、一人添柴、一人观察；发言触发后，只有与信息相关的手部或视线暂停，其他低幅任务可继续。
- 道具归属、容器支撑和动作路径优先可读，摄影机可借锅沿、篮口或门框形成前景，但不遮掉活动手和口型。

### 喜剧揭示与反应

- 先用关系镜建立观众以为正常的状态，再让错物、错话或迟到认知进入。笑点可落在动作冻结、视线错误落点、最晚反应者或恢复体面的小动作。
- 揭示镜与反应镜是否切开由节奏决定；不要在同一瞬间让全员转头、摄影机甩动、道具飞出和光线变化共同抢梗。

### 无台词原因与结果

- 画面依次让观众读到原因、人物察觉、决定、动作、物理反馈和新状态；可用构图、遮挡、插入、视线或声音提示连接，不用旁白补解释。
- 如果原因与结果无法在同一景别读清，可拆成稳定的证据镜和结果镜。尾帧的新道具位置、人物距离或环境变化应能证明动作已经完成。

### 参考素材职责示例

- 人物设定图：只约束身份外观、服装与体型，不约束本镜姿势和背景。
- 场景材质图：只约束建筑、陈设和表面质感，不改变人物站位与剧情道具。
- 已审核站位图：只约束相对位置、朝向、遮挡、摄影机轴侧与大致视场；忽略标签、箭头、线条、白底和示意比例。
- 动作或摄影参考：只约束明确声明的节拍、路径或构图关系。多个参考冲突时，由模型在文字中明确本镜优先关系。
