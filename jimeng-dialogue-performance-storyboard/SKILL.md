...
3. **蓝图冻结**：从同一份内部镜头蓝图联合冻结每镜职责与首读点、起态、刺激、人物策略、主要变化、动作路径、摄影选择、台词功能与语义转折、声音弧线、反应时点、落态和具体风险。关键镜保留完整表演因果与关系结果，普通镜保留基线、意图/触发、主要过程和停止状态。冻结前以成片观感复看一次；冻结后若发现现有方案虽无硬错但表演被压平、关系不可读、台词语气失真、核心情绪/类型收益未被呈现或镜头实际平庸，可局部重开受影响的导演选择并重新冻结，不限于硬错误。不得因格式、关键词或无证据审美偏好反复重算。内部蓝图不交付。
...
- 对白必须与表演握手：先依据人物知情、关系对象、这句话当下要完成的现实作用、对外策略和未完全外露的压力，统一确定身体表演与声音弧线，再落实说前准备、说中关键词或语义转折、说后余波。语气不能只由标点或“愤怒、悲伤、冷漠”等情绪词推断；受话者不能提前知道尚未说出的内容，口型只属于说话者。
